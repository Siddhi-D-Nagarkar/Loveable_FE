...
export function ProjectsDashboard() {
    ...
    const handleRenameSubmit = async () => {
        ...
        try {
            const updated = await api.updateProject(projectToRename.projectId.toString(), renameName);
            setProjects(projects.map(p => p.projectId === projectToRename.projectId ? {
                ...p,
                    ...
                    <Dialog open={isRenameDialogOpen} onOpenChange={setIsRenameDialogOpen}>
                        <DialogContent>
                            ...
                            <DialogFooter>
                                ...
                                <Button onClick={handleRenameSubmit} disabled={!renameName.trim() || renameName === projectToRename?.projectName}>
                                    Save
                                </Button>
                            </DialogFooter>
                        </DialogContent>
                                ...
                                <CardHeader className="p-0">
                                    <div className="aspect-video bg-muted/50 w-full relative overflow-hidden rounded-t-lg">
                                        <div
                                            ...
                                            style={generateGradient(project.projectName)}
                                        />
                                    </div>
                                </CardHeader>
                                    ...
                                    <div className="flex justify-between items-start gap-2">
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem onClick={(e) => handleDownloadProject(e, project.projectId)}>
                                                    <Download className="w-4 h-4 mr-2" />
                                                    Download
                                                </DropdownMenuItem>
                                                <DropdownMenuItem className="text-red-500 focus:text-red-500" onClick={(e) => handleDeleteProject(e, project.projectId)}>
